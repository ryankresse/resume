...
\usepackage[top=.9in, bottom=.9in, left=1.4in, right=1.4in]{geometry}
\usepackage{lastpage}
\usepackage{nopageno}
\usepackage{fancyhdr}
\usepackage{enumitem}
...
\newfontfamily\sectionfont[]{OpenSans-Bold}
\newfontfamily\subSectionfont{OpenSans-Regular}

\newfontfamily\titleFont{OpenSans-Bold}

\titleformat*{\section}{\fontsize{12pt}{\parskip}\sectionfont\selectfont}
\titleformat*{\subsection}{\fontsize{12pt}{\parskip}\subSectionfont\selectfont}
...
\begin{document}
	...
	\flushleft{
		\fontsize{24pt}{\parskip}
		\titleFont \selectfont \color{RyanRed} Ryan Kresse
	}
	
	\smallskip
	
	\noindent {\fontsize{8pt}{\parskip}\selectfont rkresse53@gmail.com $\vert$ ryankresse.com $\vert$ github.com/ryankresse $\vert$ 843-696-8459}
